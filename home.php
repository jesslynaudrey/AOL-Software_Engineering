...
<script>
                ...
                if (xhr.status === 200) {
                    ...
                    if (event) {
                        ...
                        popupContent.innerHTML = `
                          <img src="image/${event.Image}" style="width: 40%; margin-left: 170px; object-fit: cover;">
                          <h2>${event.Nama_Event}</h2>
                          <p>${event.Deskripsi_Event}</p>
                          <b><span class="close-btn" onclick="showSecondPopup()">Register</span></b>
    ...
    // Display the second popup content
    var secondPopupContent = document.querySelector("#popup .popup-content");
    secondPopupContent.innerHTML = `
        <h2 style="margin-top:50px; ">Registration Success!</h2>
        <!-- Add your registration form HTML code here -->
        <span class="close-btn" style="margin-top:100px; position:absolute; margin-left:-30px;" onclick="hidePopup()">Close</span>
    `;
}
